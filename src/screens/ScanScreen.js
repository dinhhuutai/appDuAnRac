          ...
          >
            ...
            <View style={styles.wrapperItem}>
              ...
              <View style={{
                ...
                >
                  <Picker.Item label="Ca 1" value="ca1" />
                  <Picker.Item label="Ca 2" value="ca2" />
                  <Picker.Item label="Ca 3" value="ca3" />
                  <Picker.Item label="Dài 1" value="dai1" />
                  <Picker.Item label="Dài 2" value="dai2" />
                </Picker>
              </View>
            </View>
